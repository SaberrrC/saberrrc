...
public class NoAlphaItemAnimator extends SimpleItemAnimator {
    ...
    private void animateChangeImpl(final ChangeInfo changeInfo) {
        //此处将getChangeDuration()方法修改为了0，去除oldViewAnim的alpha(0)和newViewAnimation的alpha(1)
        ...
        if (newView != null) {
            ...
            newViewAnimation.translationX(0).translationY(0).setDuration(/*getChangeDuration()*/0).
